...
<body>
    ...
    <c:otherwise>
	 ...
	 <f:form action="${submit}" method="post" modelAttribute="productObj" enctype="multipart/form-data">
		...
		<div class="form-group col-md-6">
      		...
      		<f:input type="text" class="form-control" placeholder="Enter Product Name" path="productName"/>
      		<f:errors style="color:red" path="productName"/>
    	</div>
    	<div class="form-group col-md-6">
      		<label for="price">Price:</label>
      		<f:input type="number" class="form-control" placeholder="Enter Product Price" path="price"/>
      		<f:errors style="color:red" path="price"/>
    	</div>
    	<div class="form-group col-md-6">
      		<label for="quantity">Quantity :</label>
      		<f:input type="number" class="form-control" placeholder="Enter Product Price" path="quantity"/>
