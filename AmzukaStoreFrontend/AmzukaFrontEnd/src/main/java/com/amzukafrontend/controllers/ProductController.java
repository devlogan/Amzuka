...
public class ProductController {
	...
	public ModelAndView getProductsByCategory(@PathVariable int catId,@RequestParam(name="user",required=false)Integer user){
	...
	public ModelAndView updateProductProcess(@ModelAttribute("productObj") Product product){
		...
		if(mFile2.getSize()==0){
			...
			product.setImgName1(mFile2.getOriginalFilename());	
			uploadImage(mFile2);
		}
